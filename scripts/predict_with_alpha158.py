...
def predict_with_alpha158(experiment_name, recorder_id, start_date, end_date):
    """
    使用 Alpha158 模型预测
    """
    ...
    print(f"   (即预测 {prediction_start}~{prediction_end} 的 T+1 收益率)")
...
def main():
    ...
    try:
        predict_with_alpha158(experiment_name, recorder_id, start_date, end_date)
        print("\n✅ 预测流程完成！")
        return 0
